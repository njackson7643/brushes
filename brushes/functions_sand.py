...
def write_infile(filename,tstep,equil_steps,sample_steps,temp,substr_len,atom_type_list,dump_int,dielectric,thermo_step):
    ...
    wfile.write("compute osm_press all pressure NULL pair kspace virial\n")
    wfile.write("thermo_style custom step dt c_real_temp c_osm_press press vol etotal ke pe ebond eangle evdwl ecoul elong\n\n")
